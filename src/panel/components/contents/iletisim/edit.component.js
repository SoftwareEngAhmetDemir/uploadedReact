...
export default function ContentEdit(props) {
  ...
  function getContentData() {
    axios.get(ENDPOINT+`/content/iletisim/${props.match.params.id}`).then((response) => {
      setState({
        ...state,
  ...
  const onSubmit = async (e) => {
    ...
    axios
      .post(ENDPOINT+`/content/iletisim/${props.match.params.id}`, Content)
      .then((res) => {
  ...
  const deleteData = (id) => {
    axios.delete(ENDPOINT+`/content/iletisim/${id}`).then((res) => {
