...
export default function ContentList() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (rowData) => (
        <div>
          <Link to={`/panel/iletisim/edit/${rowData._id}`}>
            <Edit />
          </Link>
        </div>
      ),
  ...
  const getContentData = () => {
    axios.get(ENDPOINT+'/content/iletisim').then((response) => {
              ...
              editable={{
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    axios
                      .post(ENDPOINT+'/content/iletisim/add', {
                        name: newData.name,
                      })
                      .then((response) => {
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    axios
                      .post(ENDPOINT+`/content/iletisim/${newData._id}`, {
                        name: newData.name,
                      })
                      .then((response) => {
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    axios
                      .delete(ENDPOINT+`/content/iletisim/${oldData._id}`)
                      .then((response) => {
                        const index = contentcategories.indexOf(oldData);
