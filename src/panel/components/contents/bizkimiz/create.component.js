...
export default function ContentCreate() {
  ...
  const onSubmit = async (e) => {
    ...
    if (gState.uploadPictures) {
      ...
      await axios
        .post(ENDPOINT+'/uploadimg/uploadimg/' + 'bizkimiz', data)
        .then((res) => {
    ...
    axios.post(ENDPOINT+'/content/bizkimiz/add', Content).then((res) => {
                  ...
                  <FormGroup className='FormGroup'>
                    <FormControl>
                      <TextValidator
                        ...
                        required
                      />
                      <FormHelperText>{t('You Need a Title')}</FormHelperText>
                    </FormControl>
                  </FormGroup>
                </Grid>
                <Grid container item sm={4} spacing={0}>
