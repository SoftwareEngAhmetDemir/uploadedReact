...
export default function ContentList() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (rowData) => (
        <div>
          <Link to={`/panel/bizkimiz/edit/${rowData._id}`}>
            <Edit />
          </Link>
        </div>
      ),
  ...
  const getContentData = () => {
    axios.get(ENDPOINT+'/content/bizkimiz').then((response) => {
            ...
            <MaterialTable
              ...
              editable={{
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    axios
                      .post(ENDPOINT +`/content/${newData._id}`, {
                        name: newData.name,
                      })
                      .then((response) => {
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    axios.delete(ENDPOINT +`/content/${oldData._id}`).then((response) => {
                      const index = contentcategories.indexOf(oldData);
