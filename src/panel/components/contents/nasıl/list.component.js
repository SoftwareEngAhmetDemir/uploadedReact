...
export default function ContentList() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (rowData) => (
        <div>
          <Link to={`/panel/nasıl/edit/${rowData._id}`}>
            <Edit />
          </Link>
        </div>
      ),
  ...
  const getContentData = () => {
    axios.get(ENDPOINT+'/content/nasil').then((response) => {
              ...
              editable={{
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    axios
                      .post(ENDPOINT+'/content/nasil/add', {
                        name: newData.name,
                      })
                      .then((response) => {
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    axios
                      .post(ENDPOINT+`/content/nasil/${newData._id}`, {
                        name: newData.name,
                      })
                      .then((response) => {
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    axios
                      .delete(ENDPOINT+`/content/nasil/${oldData._id}`)
                      .then((response) => {
                        const index = contentcategories.indexOf(oldData);
                ...
                components={{
                  Toolbar: (props) => (
                    <div>
                      ...
                      <Link to='/panel/nasılcreate' className='addButtonPlace'>
